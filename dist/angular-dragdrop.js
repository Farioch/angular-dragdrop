(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		var a = typeof exports === 'object' ? factory(require("angular")) : factory(root["_"]);
...
var dragImageService = function () {
    function dragImageService() {
        _classCallCheck(this, dragImageService);
    }

    _createClass(dragImageService, [{
        key: 'generate',
        value: function generate(text, options) {
            var config = _angular2.default.extend({}, defaultConfig, options || {});
    ...
    return dragImageService;
}();

exports.default = dragImageService;
...
function uiDroppableDirective($parse, $rootScope) {
    return function (scope, element, attr) {
        ...
        function onDrop(e) {
            ...
            sendData = _angular2.default.fromJson(sendData);
...
exports.default = uiDroppableDirective;
module.exports = exports['default'];
...
function uiDraggableDirective($parse, $rootScope, $dragImage) {
    return function (scope, element, attrs) {
        ...
        if (_angular2.default.isString(attrs.dragHandleClass)) {
        ...
        function setDragElement(e, dragImageElementId) {
            ...
            scope.$apply(function () {
                ...
                if (!(elementId && _angular2.default.isString(elementId))) {
                    return;
                }
        ...
        function dragstartHandler(e) {
            ...
            if (isDragAllowed) {
                ...
                if (dragImage && hasNativeDraggable) {
                    ...
                    scope.$apply(function () {
                        ...
                        if (dragImageParameters) {
                            if (_angular2.default.isString(dragImageParameters)) {
                ...
                var transferDataText = _angular2.default.toJson(transferDataObject);
...
exports.default = uiDraggableDirective;
module.exports = exports['default'];
...
var _uiDraggable = __webpack_require__(3);

var _uiDraggable2 = _interopRequireDefault(_uiDraggable);

var _uiDroppable = __webpack_require__(2);

var _uiDroppable2 = _interopRequireDefault(_uiDroppable);

var _dragImage = __webpack_require__(1);

var _dragImage2 = _interopRequireDefault(_dragImage);
...
var _module = _angular2.default.module('angular-dragdrop', []);

if (isDnDsSupported()) {
    _module.directive('uiDraggable', _uiDraggable2.default);
    _module.directive('uiDroppable', _uiDroppable2.default);
    _module.service('dragImageService', _dragImage2.default);
}
